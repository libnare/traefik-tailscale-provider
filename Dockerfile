...
ARG APP_NAME=traefik-tailscale-provider
ARG PROFILE=release
...
COPY --from=builder /tmp/app/traefik-tailscale-provider /traefik-tailscale-provider

EXPOSE 8080

ENTRYPOINT ["/traefik-tailscale-provider"]